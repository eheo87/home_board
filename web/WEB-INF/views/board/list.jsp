                ...
                <c:forEach items="${list}" var="list">
                    <tr>
                        ...
                        <td>
                            ...
                            <c:if test="${list.reply_Cnt ne 0}">
                                <small><b>[<c:out value="${list.reply_Cnt}"/>]</b></small>
                            </c:if>
                        </td>
            ...
            <div class="search row">
                ...
                <div class="col-xs-10 col-sm-10">
                    <div class="input-group">
                        <input type="text" name="keyword" id="keywordInput" value="${scri.keyword}" class="form-controll"/>
                        <span class="input-group-btn">
                            <button id="searchBtn" type="button" class="btn btn-defalut">검색</button>
                        </span>
                    </div>
                </div>
